...
1248 Movies were make in this year.
...
Chamber of Secrets, Prisoner of Azkaban, and Sorceres Stone are in the data set. Prisoner of Azkaban has the highest rating and Sorcerers Stone has the most votes.
...
"Wild Wild West" has the highest budjet for comedies or animations with more than 100 votes.
...
No "Star Wars Revenge of the Sith" is not in the data set unfortunately.

We can however ask questions using the "or" function and arrange by rating we can demonstrate that a difference series such as the lord of the rings has overall higher ratings than the star wars movies.
